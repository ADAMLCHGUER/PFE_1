...
class RapportStatistiques extends Command
{
    protected $signature = 'app:rapport-statistiques';
    ...
    public function handle()
    {
        ...
        foreach ($prestataires as $prestataire) {
            try {
                ...
                if ($rapport) {
                    $rapportsGeneres++;
                    $this->info("Rapport généré pour {$prestataire->nom_entreprise}");
                } else {
                ...
                Log::error("Erreur rapport: {$e->getMessage()}", ['prestataire' => $prestataire->id, 'trace' => $e->getTraceAsString()]);
            }
        }
